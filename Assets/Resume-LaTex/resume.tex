...
\jobentry{Game Developer}{Agate | 2026 - Present}
\begin{itemize}[leftmargin=*, nosep, itemsep=2pt, topsep=2pt]
    \item Currently developing an unannounced game project (TBA).
\end{itemize}
...
{\small IEEE Access (Volume: 13) | Nov 2, 2025\\
...
{\small IEEE Access (Volume: 12) | Sep 12, 2024\\
DOI: 10.1109/ACCESS.2024.3457801}

\vspace{0.4cm}

\textbf{Enhancing Serious Game Experience Through In-Game Radio Using Context-Aware Recommender System Based on Player Behavior}\\
{\small INASS International Journal of Intelligent Engineering and Systems | Sep 2, 2024\\

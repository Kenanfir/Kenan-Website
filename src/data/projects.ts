...
export const projects: Project[] = [
    // ON_GOING
    {
        ...
        title: 'Clone World',
        role: 'GAME DEVELOPER',
        description: 'A life simulation game with AI agents possessing personality and memory. (On-going, not released)',
        thumbnail: '',
        teamSize: 1,
        duration: 'Ongoing',
        platform: 'Engine TBA',
        category: 'ON_GOING',
        year: 'Ongoing',
        about: 'Clone World is a life simulation game highlighting AI agents that possess distinct personalities and long-term memory. The project focuses on creating alive and dynamic worlds where NPCs actually remember their past interactions and have unique shifting personalities over time.',
        info: {
            role: 'Game Developer',
            teamSize: '1 member',
            timeFrame: 'Ongoing',
        ...
        sections: [
            { heading: 'INTRODUCTION', content: 'An ambitious life simulation game focusing on AI-driven NPCs.' },
            { heading: 'KEY FEATURES', content: 'Unique AI agent personalities, long-term memory systems, dynamic world events.' },
        ],
    },
    {
        ...
        category: 'ON_GOING',
        year: 'Ongoing',
        about: 'Vibe Coding Tycoon lets you experience the ultimate chill of managing a game development studio while employing vibe coding techniques. Try to build the most profitable and highly acclaimed games while keeping your developers relaxed.',
        info: {
            role: 'Game Developer',
            teamSize: '1 member',
            timeFrame: 'Ongoing',
        ...
        sections: [
            { heading: 'INTRODUCTION', content: 'A tycoon game centered around game development studio management.' },
            { heading: 'KEY FEATURES', content: 'Studio management, vibe coding mechanic, game release simulation.' },
        ],
    },
    {
        ...
        category: 'ON_GOING',
        year: 'Ongoing',
        about: 'Roasting Ur Decision is an app that uses AI to humorously roast users based on their daily life choices. Enter what you decided to do today, and let the AI judge you mercilessly in a fun way.',
        info: {
            role: 'App Developer',
            teamSize: '1 member',
            timeFrame: 'Ongoing',
        ...
        sections: [
            { heading: 'INTRODUCTION', content: 'A humor-based AI app that roasts life decisions.' },
            { heading: 'KEY FEATURES', content: 'AI-generated roasts, daily logs, shareable results.' },
        ],
    },
    {
        slug: 'agreely',
        title: 'Agreely',
        role: 'SOFTWARE HOUSE / APP DEV',
        description: 'A freelance platform app and software house helping to generate revenue and secure clients. (On-going)',
        thumbnail: '',
        teamSize: 3,
        duration: 'Ongoing',
        platform: 'Web / App',
        category: 'ON_GOING',
        year: 'Ongoing',
        about: 'Agreely operates as a freelance app platform and a software house. Our goal is to connect freelancers with clients while simultaneously taking on our own software house projects to generate revenue and build a sustainable client base.',
        info: {
            role: 'Software House / App Dev',
            teamSize: '3 members',
            timeFrame: 'Ongoing',
        ...
        sections: [
            { heading: 'INTRODUCTION', content: 'A freelance platform and active software house operation.' },
            { heading: 'KEY FEATURES', content: 'Client acquisition, freelance networking, software development services.' },
        ],
    },
    // 2025
    {
